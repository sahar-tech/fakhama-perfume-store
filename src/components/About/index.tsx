...
const About = () => {
  ...
  return (
    <>
      <Breadcrumb title={t("global.navigation.about")} /*pages={["about"]}*/ />
            ...
            <div className="xl:max-w-[370px] w-full bg-white rounded-xl shadow-1">
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  <p className="flex items-center gap-4 text-dark-2">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 22 22"
                  ...
                  <p className="flex gap-4 text-dark-2">
                    <svg
              ...
              <form>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    <label htmlFor="firstName" className="block mb-2.5 text-dark-4">
                  ...
                  <div className="w-full">
                    <label htmlFor="lastName" className="block mb-2.5 text-dark-4">
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    <label htmlFor="subject" className="block mb-2.5 text-dark-4">
                      Subject
                    </label>
                  ...
                  <div className="w-full">
                    <label htmlFor="phone" className="block mb-2.5 text-dark-4">
                      Phone
                    </label>
                ...
                <div className="mb-7.5">
                  <label htmlFor="message" className="block mb-2.5 text-dark-4">
                    Message
                  </label>
